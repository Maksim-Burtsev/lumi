...
INTRO_QUESTIONS: list[tuple[MemoryCandidateKind, str, str]] = [
    ...
    ("preference",
     ...
     "Рабочий ритм"),
    ("preference",
     "Какие темы новостей тебе интересны? Перечисли через запятую — потом сможешь завести по ним дайджест.",
     "Интересные темы новостей"),
    ("instruction",
...
INTRO_DONE_TEXT = (
    ...
    "Всё, что я запомнил, видно в Mini App → Память — там можно поправить или удалить.\n"
    "Дальше просто пиши мне: задачи, планы, вопросы."
)
